...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 26 2025 г., 10:50
...
INSERT INTO `drugs` (`drug_id`, `name`, `manufacturer`, `purpose`, `category`, `unit_of_measurement`, `purchase_price`, `selling_price`) VALUES
(1, 'Амоксициллин', 'ФармаКорп', 'Антибактериальный', 'Антибиотики', 'таблетки', 100.00, 150.00),
(2, 'Парацетамол', 'Здоровье', 'Жаропонижающее', 'Обезболивающие', 'таблетки', 20.00, 35.00),
(3, 'Ибупрофен', 'МедФарм', 'Противовоспалительное', 'Обезболивающие', 'капсулы', 30.00, 50.00),
(4, 'Цефтриаксон', 'ФармаИнтер', 'Антибактериальный', 'Антибиотики', 'шт', 150.00, 200.00),
(5, 'Аспирин', 'Здоровье', 'Жаропонижающее', 'Обезболивающие', 'таблетки', 10.00, 22.00);
